...
namespace VersaoFinal.Forms
{
    public partial class AdminForm : Form
    {
        ...
        private void dataViz()
        {
            ...
            datapoint1.addLabely("SEG", random.Next(0, 50).ToString());
            datapoint1.addLabely("TER", random.Next(0, 50).ToString());
            datapoint1.addLabely("QUA", random.Next(0, 50).ToString());
            datapoint1.addLabely("QUI", random.Next(0, 50).ToString());
            datapoint1.addLabely("SEX", random.Next(0, 50).ToString());
            datapoint1.addLabely("SAB", random.Next(0, 50).ToString());
            datapoint1.addLabely("DOM", random.Next(0, 50).ToString());
        ...
        private void adminChangeLogin()
        {
            try
            {
                if (String.IsNullOrWhiteSpace(TextBoxUsername.Text) && String.IsNullOrWhiteSpace(TextBoxPassword.Text))
                {
                    ...
                    labelPasswordMessage.Text = "Por favor entre com o usuário e a senha ";
                }
                else
                {
                    if (String.IsNullOrEmpty(TextBoxUsername.Text) == false && String.IsNullOrEmpty(TextBoxPassword.Text) == false)
                    {
                        ...
                        labelPasswordMessage.Text = ("Usuário e Senha atualizados com sucesso!");
                    }
                    else if (String.IsNullOrEmpty(TextBoxUsername.Text) == false)
                    {
                        ...
                        cmd.ExecuteNonQuery();
                        labelPasswordMessage.ForeColor = Color.Green;
                        labelPasswordMessage.Text = ("Usuário atualizado com sucesso!");
                    }
                    ...
                    else
                    {
                        ...
                        cmd.ExecuteNonQuery();
                        labelPasswordMessage.ForeColor = Color.Green;
                        labelPasswordMessage.Text = ("Senha atualizada com sucesso!");
                    }
            ...
            {
                labelPasswordMessage.ForeColor = Color.Red;
                labelPasswordMessage.Text = "Operação falhou ";
            }
        ...
        private void AddCategory()
        {
            try
            {
                ...
                LabelMessageCategory.Text = ("Categoria adicionada com sucesso!");
                dBCon.CloseCon();
            ...
            catch
            {
                ...
                LabelMessageCategory.Text = "Falha em adicionar a categoria";
            }
...

        {
            try
            {
                ...
                {
                    LabelMessageCategory.ForeColor = Color.Red;
                    LabelMessageCategory.Text = ("Falta informações");
                }

                else
                {
                    string updateQuery = "UPDATE Category SET Nome='" + TextBoxNameCategory.Text + "',Descrição ='" + TextBoxDescriptionCategory.Text + "'WHERE ID =" + TextBoxIDCategory.Text + " ";
                    SqlCommand cmd = new SqlCommand(updateQuery, dBCon.GetCon());
                    dBCon.OpenCon();
                    cmd.ExecuteNonQuery();
                    LabelMessageCategory.ForeColor = Color.Green;
                    LabelMessageCategory.Text = ("Categoria atualizada com sucesso!");
                    dBCon.CloseCon();
                    getTable(DataGridViewCategory, "Category");
                    ClearCategory();
                }
            ...
            {
                LabelMessageCategory.ForeColor = Color.Red;
                LabelMessageCategory.Text = "Falha na atualização";
            }
        ...
        private void DeleteCategory()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                LabelMessageCategory.ForeColor = Color.Green;
                LabelMessageCategory.Text = ("Categoria deletada com sucesso");
                dBCon.CloseCon();
                getTable(DataGridViewCategory, "Category");
                ClearCategory();
        ...
        // getCategory function implementation used on Manage product section
        ...
        private void getCategory()
        {
            ...
            ProductCategoryDropdown.ValueMember = "Nome";
            ProductCategoryDropdownSearch.DataSource = table;
            ProductCategoryDropdownSearch.ValueMember = "Nome";
        }
        ...
        private void AddProducts()
        {
            try
            {
                ...
                LabelMessageProduct.Text = ("Produto adicionado com sucesso");
                dBCon.CloseCon();
            ...
            catch
            {
                ...
                LabelMessageProduct.Text = "Falha em adicionar o produto";
            }
        ...
        private void UpdateProduct()
        {
            try
            {
                ...
                {
                    LabelMessageProduct.ForeColor = Color.Red;
                    LabelMessageProduct.Text = ("Falta informações");
                }

                else
                {
                    string updateQuery = "UPDATE Product SET Nome='" + TextBoxNameProduct.Text + "',Preço =" + TextBoxPriceProduct.Text + ",Quantidade=" + TextBoxQuantityProduct.Text + " WHERE ID =" + TextBoxIDProduct.Text + " ";
                    SqlCommand cmd = new SqlCommand(updateQuery, dBCon.GetCon());
                    dBCon.OpenCon();
                    cmd.ExecuteNonQuery();
                    LabelMessageProduct.ForeColor = Color.Green;
                    LabelMessageProduct.Text = ("Produto atualizado com sucesso");
                    dBCon.CloseCon();
                    getTable(DataGridViewProducts, "Product");
                    ClearProduct();
                }
            ...
            {
                LabelMessageProduct.ForeColor = Color.Red;
                LabelMessageProduct.Text = "Falha em atualizar! ";
            }
        ...
        private void DeleteProduct()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                LabelMessageProduct.ForeColor = Color.Green;
                LabelMessageProduct.Text = ("Produto deletado com sucesso!");
                dBCon.CloseCon();
                getTable(DataGridViewProducts, "Product");
                ClearProduct();
            ...
            {
                LabelMessageProduct.ForeColor = Color.Red;
                LabelMessageProduct.Text = "Falha ao deletar ";
            }
        }
        ...
        private void AddSellers()
        {
            try
            {
                ...
                LabelMessageSellers.Text = ("Vendedor " + TextBoxNameSellers.Text + " adicionado com sucesso!");
                dBCon.CloseCon();
            ...
            catch
            {
                ...
                LabelMessageSellers.Text = "Falha em adicionar o vendedor";
            }
        }
        ...
        private void UpdateSellers()
        {
            try
            {
                ...
                {
                    LabelMessageProduct.ForeColor = Color.Red;
                    LabelMessageSellers.Text = ("Falta de Informação!");
                }

                else
                {
                    string updateQuery = "UPDATE Sellers SET Nome='" + TextBoxNameSellers.Text + "',Senha ='" + TextBoxPasswordSellers.Text + "',Contato='" + TextBoxPhoneSellers.Text + "' WHERE ID =" + TextBoxIDSellers.Text + " ";
                    SqlCommand cmd = new SqlCommand(updateQuery, dBCon.GetCon());
                    dBCon.OpenCon();
                    cmd.ExecuteNonQuery();
                    LabelMessageSellers.ForeColor = Color.Green;
                    LabelMessageSellers.Text = ("Vendedores " + TextBoxNameSellers.Text + " atualizado com sucesso!");
                    dBCon.CloseCon();
                    getTable(DataGridViewSellers, "Sellers");
                    ClearSellers();
                }
        ...
        {
            string selectQuery = "SELECT * FROM Sellers WHERE Nome LIKE '%" + TextBoxSearchSellers.Text + "%'";
            SqlCommand cmd = new SqlCommand(selectQuery, dBCon.GetCon());
            SqlDataAdapter adapter = new SqlDataAdapter(cmd);
            DataTable table = new DataTable();
            adapter.Fill(table);
        ...
        {
            dBCon.OpenCon();
            string selectQuery = "SELECT * FROM Bill WHERE Nome LIKE '%" + TextBoxSearchBills.Text + "%'";
            SqlCommand cmd = new SqlCommand(selectQuery, dBCon.GetCon());
            SqlDataAdapter adapter = new SqlDataAdapter(cmd);
            DataTable table = new DataTable();
            adapter.Fill(table);
            ...
            string selectQuery1 = "SELECT  SUM(Total) AS Total FROM Bill  WHERE Nome LIKE '%" + TextBoxSearchBills.Text + "%'";
        ...
        {
            string selectQuery = "SELECT * FROM Product WHERE Categoria ='" + ProductCategoryDropdownSearch.SelectedValue.ToString() + "'";
            SqlCommand cmd = new SqlCommand(selectQuery, dBCon.GetCon());
            SqlDataAdapter adapter = new SqlDataAdapter(cmd);
            DataTable table = new DataTable();
            adapter.Fill(table);
